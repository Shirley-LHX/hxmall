...
import com.shirley.hxmall.dao.ProductImgMapper;
import com.shirley.hxmall.dao.ProductMapper;
import com.shirley.hxmall.dao.ProductParamsMapper;
import com.shirley.hxmall.dao.ProductSkuMapper;
import com.shirley.hxmall.entity.*;
import com.shirley.hxmall.service.ProductService;
import com.shirley.hxmall.utils.PageHelper;
...
public class ProductServiceImpl implements ProductService {
    ...
    public ResultVO getProductBasicInfo(String productId) {
        ...
        if(products.size()>0){
            ...
            return new ResultVO(ResStatus.FAILED,"查询的商品不存在！",null);
        }
    }
    ...
    public ResultVO getProductParamsById(String productId) {
        ...
        if(productParams.size()>0){
            ...
            return new ResultVO(ResStatus.FAILED,"此商品可能为三无产品",null);
        }
    }
